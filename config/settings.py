...
SECRET_KEY = 'django-insecure-!zc^u#p2utidc#qujz-$s6y#8&k%2uko=b$di3o$9ysqig)!r5'
...
INSTALLED_APPS = [
    ...
    'allauth',
    'allauth.account',
    'allauth.socialaccount', #  gmail などのソーシャルアカウントによる認証機能に必要 ソーシャルアカウント認証を使わない場合でもアプリ追加が必須
    'crispy_forms',
]
...
EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend' # メールの送信先をログに指定。本来はメールアプリを作成